...
{ // Function to connect and reconnect as necessary to the MQTT server.
  ...
  while ((_VARL_ret = _VAR_MQTT_Secure_Client.connect()) != 0)
...
//======================================================================================
void FUNC_MQTT_Paket()
{ // Check, that the MQTT Connection is alive and wait for packets
...
void FUNC_MQTT_PublishMessage(char *_VARL_MessageText)
{ // Publish a MQTT Message, with error check
  // delay(1200);
